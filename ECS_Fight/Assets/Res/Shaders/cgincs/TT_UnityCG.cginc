...
#include "TT_UnityShaderUtilities.cginc"
#include "TT_UnityInstancing.cginc"
//
#ifdef UNITY_COLORSPACE_GAMMA

#define unity_ColorSpaceGrey fixed4(0.5, 0.5, 0.5, 0.5)
#define unity_ColorSpaceDouble fixed4(2.0, 2.0, 2.0, 2.0)
#define unity_ColorSpaceDielectricSpec half4(0.4, 0.4, 0.4, 1.0 - 0.220916301)//修改过数值，提高光滑物体反光亮度
