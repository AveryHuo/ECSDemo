...
Shader "StarStudio/Role/SSPlayer(UI)" 
{
    Properties 
    {
        [Header(Cull)]
        ...
        _StraightSpecPower ("流线高光锐度", Range(0, 500)) = 100
        ...
        _BloomIntensity("Bloom Intensity", Range(0, 2)) = 1

        [Toggle] _BloomMask("Bloom Mask", Float) = 0
